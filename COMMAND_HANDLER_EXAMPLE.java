...
public class CommandHandlerExample {
    ...
    private static ResponseAction parseCommand(
        ...
        switch (type) {
            case "move_closer":
                Vec3d playerPos = entity.getWorld().getPlayerByUuid(
                    entity.getLastInteractedPlayerId()
                ).getPos();
                return new MoveCloserAction(playerPos, 3.0);
            ...
            case "look_at_player":
                return new LookAtPlayerAction(entity.getLastInteractedPlayerId());
